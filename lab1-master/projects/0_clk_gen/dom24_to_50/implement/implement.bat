...
xst -ifn xst.scr
move dom24_to_50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dom24_to_50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dom24_to_50_exdes.ucf dom24_to_50_exdes

echo 'Running map'
map -timing -pr b dom24_to_50_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dom24_to_50_exdes -w routed.ncd routed.v
cd ..
